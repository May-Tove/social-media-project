...
const postUrl = `${api_base_url}/api/v1/social/posts?_author=true&_comments=true&reactions=true`;
...
/*function displayPosts(posts) {
  posts.forEach((post) => {
    ...
    postsContainer.innerHTML += `<article class="bg-white p-4 rounded mb-4 shadow-sm">
        ...
        <div class="d-flex align-items-center">
          ...
          <div>
            ...
            <small class="text-muted m-0">Posted: ${datePosted}</small>
          </div>
          </div>
          <div class="d-flex">
          ...
          <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
            ...
            <button title="Delete post" class="border-0 d-flex align-items-top p-0" id="edit-btn" type="button">
        ...
        <a href="single_post.html?id=${post.id}" class="border-bottom post-link">
          <h5>${post.title}</h5>
          <p>${post.body}</p>
...
postForm.addEventListener("submit", function (e) {
  ...
  const imgUpload = document.querySelector(".media-attachment img").value;
